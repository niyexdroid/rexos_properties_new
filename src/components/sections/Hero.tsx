  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-6 md:-mt-16 relative z-30">
        {/* Mobile title */}
        <h2 className="md:hidden text-xl font-bold text-navy mb-4">Explore Our Portfolio</h2>
        <div className="bg-white rounded-2xl shadow-xl p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            {/* Type */}
            <div>
              <label htmlFor="hero-type" className="text-xs font-semibold text-navy mb-1 block">Type</label>
            ...
            {/* Number Of Rooms */}
            <div>
              <label htmlFor="hero-rooms" className="text-xs font-semibold text-navy mb-1 block">Number Of Rooms</label>
              <div className="relative flex items-center">
